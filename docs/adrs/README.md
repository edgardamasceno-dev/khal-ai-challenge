...
| [0004](./ADR-0004-retrieval-lexico-strategy.md) | Retrieval lexico com Strategy plugavel (revisado: comparativo RAG-lexico x CAG x pgvector x Graph RAG/RLM) | Accepted (revisado 2026-05-31, R-14) |
